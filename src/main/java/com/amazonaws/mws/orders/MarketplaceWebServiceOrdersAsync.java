...
public interface MarketplaceWebServiceOrdersAsync extends MarketplaceWebServiceOrders {
     ...
     * @return {@code Future<GetOrderResponse>} response.
     */
     ...
     * @return {@code Future<ListOrderItemsResponse>} response.
     */
     ...
     * @return {@code Future<ListOrderItemsByNextTokenResponse>} response.
     */
     ...
     * @return {@code Future<ListOrdersResponse>} response.
     */
     ...
     * @return {@code Future<ListOrdersByNextTokenResponse>} response.
     */
